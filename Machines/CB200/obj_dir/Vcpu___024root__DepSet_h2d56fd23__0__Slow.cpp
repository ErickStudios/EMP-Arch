...
VL_ATTR_COLD void Vcpu___024root___ctor_var_reset(Vcpu___024root* vlSelf) {
    ...
    // Body
    vlSelf->rex = VL_RAND_RESET_I(1);
    vlSelf->wex = VL_RAND_RESET_I(1);
    vlSelf->adr = VL_RAND_RESET_I(16);
    vlSelf->wvx = VL_RAND_RESET_I(8);
    vlSelf->rvx = VL_RAND_RESET_I(8);
    vlSelf->ins = VL_RAND_RESET_I(16);
    vlSelf->exi = VL_RAND_RESET_I(1);
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->rst = VL_RAND_RESET_I(1);
    vlSelf->ix = VL_RAND_RESET_I(1);
    vlSelf->jf = VL_RAND_RESET_I(1);
    vlSelf->ir = VL_RAND_RESET_I(1);
    vlSelf->rg = VL_RAND_RESET_I(1);
    vlSelf->rgt = VL_RAND_RESET_I(8);
    vlSelf->rid = VL_RAND_RESET_I(4);
    vlSelf->rs = VL_RAND_RESET_I(1);
    vlSelf->rsv = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__ar = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__br = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__cr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__pr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__xr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__yr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__zr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__fr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__tr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__b_rec = VL_RAND_RESET_I(1);
    vlSelf->cpu__DOT__ofr = VL_RAND_RESET_I(9);
    vlSelf->cpu__DOT__altpr = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__alt2r = VL_RAND_RESET_I(8);
    vlSelf->cpu__DOT__rcf = VL_RAND_RESET_I(1);
